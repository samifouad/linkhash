...
<div class="text-black pt-[10%] ">
    <img src="/public/tmplogo.webp" alt="logo" width="80" height="80" style="margin-left: auto; margin-right: auto;">
    <br/><br/>
    <br/>
    <div style="display:flex; flex-direction:column; width:180px; margin-left: auto; margin-right: auto;">
    ...
    <br><br>
    <a href="" class="text-2xl">How This Works</a>
    <br/><br/>
    <a href="/" class="text-2xl">Insert Link Here</a>
    <br/><br/>
    <a href="/" class="text-2xl">Credits</a>
    <br/><br/>
    dark mode toggle
</div>
<!-- </MenuMobile> -->
