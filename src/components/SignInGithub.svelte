<div style="display:flex; flex-direction:column; width:fit-content; margin-left: auto; margin-right: auto;">
    <link href="https://fonts.googleapis.com/css?family=Roboto&display=swap">
    <a class="rounded-md" href="https://api.linkha.sh/auth/v1/authorize?provider=github"
      ...
      <div style="margin: 1px; padding-top:5px; min-height:30px; padding-left:5px; padding-right:13px;">
